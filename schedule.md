...
|------|-------|-----------------|------------------|---------------------------|
| **1/6/2026** | [Intro: importance of constraints + classical approaches](https://docs.google.com/presentation/d/1hWfI4J8VLtQBtpgG6QSIKgJv2suyiuWgN-y3B9Kfo9Q/edit?slide=id.p#slide=id.p) | **Adopt Constraints Over Penalties in Deep Learning** (Ramirez et al., 2025) [[arXiv](https://arxiv.org/abs/2505.20628)] | **Optimization Learning** (Van Hentenryck, 2025) [[arXiv](https://arxiv.org/abs/2501.03443)] | Fioretto & Van Hentenryck (2020) [[arXiv](https://arxiv.org/abs/2001.09394)] | |
...
| **2/3/2026** | Safe RL: Lyapunov & reachability | **Lyapunov-based Safe RL** (BarrierNet, 2023) [[IEEE](https://ieeexplore.ieee.org/abstract/document/10077790?casa_token=zwJiG8JcRqYAAAAA:2gqm7MveM9gUFJovtnNEwyq9ujhXHA-sCO_tG4IlBc6_g0qlGTZO6az8VKzpe6m5Ks8BeSU)]) | **Reachability-Based Safety for Learning Systems** (Fisac et al, 2017) [[arXiv](https://arxiv.org/abs/1705.01292)]) | Control barrier functions; MPC + learning; robust RL formulations [1](https://arxiv.org/abs/1801.08757) | Project proposal |
...
| **2/24/2026** | Formal verification | **Vericoding / Verified Code Generation** [[survey](https://arxiv.org/abs/2306.15626)] | **Hilbert: Informal + Formal Proofs** (Varambally et al., 2025) [[arXiv](https://arxiv.org/abs/2509.22819)] | Lean-guided LLMs; proof-carrying code; formal methods for agents | Project midterm report   |
